...
hidden if the `lsl_examples_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `lsl_examples_DEVELOPER_MODE` to the configure
...
Runs the executable target `lsl_examples_exe`.
